...
public class ClassAdapter extends RecyclerView.Adapter<ClassAdapter.CourseViewHolder> {
    ...
    public ClassAdapter(Context context, List<Course> courses) {
    ...
    public CourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ClassAdapter.CourseViewHolder(view);
    }
...
//        holder.courseFeeLayout.setAnimation(AnimationUtils.loadAnimation(context, R.anim.rotate_270));
        ...
        if (Account.getType() == Account.Type.Student) {
            ...
            holder.itemView.findViewById(R.id.course_horizontal_line_bottom_divider).setVisibility(View.GONE);
            holder.enrollButton.setVisibility(View.GONE);
            holder.closeCourseButton.setVisibility(View.GONE);
