    ...
    public class Educator extends User {
        ...
        public static int getEduPositionById(String eduId) {
            for (int i=0; i<retrieved.size();i++) {
                if (retrieved.get(i).getStuId().equals(eduId))
                    return i;
            }
            return -1;
        }
        ...
        public static Educator getEduByFullname(String fullname) {
            for (int i=0; i<retrieved.size();i++) {
                if (retrieved.get(i).getFullname().equals(fullname))
                    return retrieved.get(i);
            }
            return null;
        }
        ...
        public static void hireEducator(Educator educator, String centerId, List<String> types, String position) {
            ...
            FirebaseFirestore.getInstance().collection("Educator").document(educator.getStuId())
                    .update(updates);
        }
